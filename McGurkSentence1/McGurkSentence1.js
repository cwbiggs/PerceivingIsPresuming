...
function preload() {
  correctAudio = loadSound('assets/s1_DavidCorrectAudio.mp3');
  wrongAudio = loadSound('assets/s1_DavidWrongAudio.mp3');  
  correctAudioB = loadSound('assets/s1_RheaCorrectAudio.mp3');
  wrongAudioB = loadSound('assets/s1_RheaWrongAudio.mp3');
}
...
function setup() {
  ...
  v = createVideo('assets/s1_DavidVid.mp4');
  v2 = createVideo('assets/s1_RheaVid.mp4');
  v.hide();
  v2.hide();
  v.loop();
  v2.loop();
