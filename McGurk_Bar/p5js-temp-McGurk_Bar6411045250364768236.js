...
function preload() {
  ...
  //  sfMatched[i] = loadSound(aCorrect);
  //  sfMatched[i].stop();
  //  sfMisMatched[i] = loadSound(aWrong);
  //  sfMisMatched[i].stop();
  //}
  
  //sfMatched[0] = loadSound("assets/aCorrect0.mp3");
  //sfMisMatched[0] = loadSound("assets/aWrong0.mp3");
}
...
function setup() {
  ...
  //m = createVideo('assets/v0.mp4');
  //d = createVideo('assets/v1.mp4');
  //r = createVideo('assets/v2.mp4');
  vidLoad();
