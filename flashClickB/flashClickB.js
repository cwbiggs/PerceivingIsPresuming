...
var sliderDefaults = [20, 0, 160, 80, 20];
...
var flashDurationMin = 50;
var flashDurationMax = 300;

//timing
var loopLength;
var m;
var threshLow = [0, 750, 800];
threshLow[2] = threshLow[1]+100;
...
function setup() {
  ...
  components = new Components("Click-Flash B", borders[0], borders[1], borders[2], borders[3]);
  //create help region
...
function draw() {
  ...
  m = millis() % loopLength;
  threshHigh[0] = flashDuration;
  threshLow[1] = eventSep;
  threshHigh[1] = eventSep+flashDuration;
  threshLow[2] = threshHigh[1]+flashDuration*0.8;
  threshHigh[2] = threshLow[2]+flashDuration;
