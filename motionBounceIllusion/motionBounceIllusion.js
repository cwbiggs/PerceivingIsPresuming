...
var sliderNames = ["Size", "Speed", "Transparency", "Rotate", "Quantity"];
var sliderOffsetX = 50;
var sliderDefaults = [80, 50, 75, 0, 0];
var sliderHelp = ["increase ball size to see pass", "decrease ball speed to see pass", "increase transparency to see pass", "roate ball position", "show more balls"]
...
function draw() {
  ...
  components.workspaceDiv([header, header + circleSize]); //create lines accoss the workhsop at a y positions relative to the workspace outline
